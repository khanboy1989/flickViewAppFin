//
//  FlickrJSONSeconViewController.m
//  FlickrJSON
//
...
#import "FlickrJSONSeconViewController.h"

#import "FlickrJSONDetailViewController.h"

//#import "FlickrAPIKey.h"

@interface FlickrJSONSeconViewController ()

@end

@implementation FlickrJSONSeconViewController

- (void)loadFlickrPhotos
{
    
    NSString *urlString = [NSString stringWithFormat:@"https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=%@&tags=%@&tag_mode=%@&per_page=10&format=json&nojsoncallback=1", @"6c84cce43672d887ca2ca76e6961d090", @"paris", @"any"];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([[segue identifier] isEqualToString:@"showDetail"]) {
        ...
        webController.FlickrKey = @"6c84cce43672d887ca2ca76e6961d090";
    }
}
